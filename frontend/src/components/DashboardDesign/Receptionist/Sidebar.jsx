    ...
    <aside id="sidebar" className={openSidebarToggle ? 'sidebar-responsive' : ''}>
      <div className="sidebar-title">
        <div className="sidebar-brand">
          <BsPersonFill className="icon_header" /> Receptionist
        </div>
      ...
      <ul className="sidebar-list">
        ...
        <li className="sidebar-list-item">
          <Link to="/dashboard/schedule-appointments" onClick={OpenSidebar}>
            <BsCalendarCheckFill className="icon" /> Schedule Appointments
          </Link>
        </li>
      </ul>
    </aside>
