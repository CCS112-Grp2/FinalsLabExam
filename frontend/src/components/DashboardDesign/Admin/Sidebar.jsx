    ...
    <aside id="sidebar" className={openSidebarToggle ? 'sidebar-responsive' : ''}>
      <div className="sidebar-title">
        <div className="sidebar-brand">
          <BsPersonFill className="icon_header" /> Admin
        </div>
      ...
      <ul className="sidebar-list">
        ...
        <li className="sidebar-list-item">
          <Link to="/dashboard/manage-doctors" onClick={OpenSidebar}>
            <BsFillPersonBadgeFill className="icon" /> Manage Doctors
          </Link>
        </li>
        <li className="sidebar-list-item">
          <Link to="/dashboard/manage-patients" onClick={OpenSidebar}>
            <BsFillPersonBadgeFill className="icon" /> Manage Patients
          </Link>
        </li>
        <li className="sidebar-list-item">
